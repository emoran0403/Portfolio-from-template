...
import { GlobalStateProvider, Theme } from "gatsby-theme-portfolio-minimal/src/context";
import { useSiteConfiguration } from "gatsby-theme-portfolio-minimal/src/hooks/useSiteConfiguration";
import { Layout } from "./LayoutWithoutFooter";
...
export function Page(props: PageProps): React.ReactElement {
    ...
    return (
        <GlobalStateProvider
            ...
            <Layout useSplashScreenAnimation={props.useSplashScreenAnimation || false} useCookieBar={siteConfiguration.featureToggles.useCookieBar}>
                {props.children}
            </Layout>
        </GlobalStateProvider>
    );
